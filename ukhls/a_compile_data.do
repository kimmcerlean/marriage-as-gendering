...
// Key updates
* April 2026: attempting to integrate wave 15 of the UKHLS (or "o")
* April 2026: while doing that, adding a few new variables to use for matching / controls later
...
local allWaves = "a b c d e f g h i j k l m n o ba bb bc bd be bf bg bh bi bj bk bl bm bn bo bp bq br"
...
use "$temp/temp_`firstWave'", clear
...
// save the long file
save "$created_data/`outputfilename'", replace

// erase temporary files
foreach w in `allWaves' {
	erase "$temp/temp_`w'.dta"
}
